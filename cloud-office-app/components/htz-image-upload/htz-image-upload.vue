<template>
	<view class="htz-image-upload-list">
		...
		<view class="preview-full" v-if="previewVideoSrc!=''">
			<video :autoplay="true" :src="previewVideoSrc" :show-fullscreen-btn="true">
				<cover-view class="preview-full-close" @click.stop="previewVideoClose" style="margin-top: 25px;"> ×
				</cover-view>
			</video>
		</view>
