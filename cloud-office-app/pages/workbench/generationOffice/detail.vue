<template>
	<view class="detailBox">
		<u-navbar :is-back="true" title="待办详情" :border-bottom="false" back-icon-color="#000" :background="background"
		...
		<button v-if="detailData.status == 0" type="default" class="sure_btn" @click="sureBtn">完成待办</button>
