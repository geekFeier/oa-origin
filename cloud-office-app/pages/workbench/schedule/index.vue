<template>
	<view class="detailBox">
		<u-navbar :is-back="true" title="新建日程安排" :border-bottom="false" back-icon-color="#000" :background="background"
		...
		<view class="mainBox">
			...
			<view class="item-con">
				<u-input type="textarea" v-model="formData.desc" placeholder="添加描述...." />
			</view>
