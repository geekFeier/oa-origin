<template>
	<view>
		<u-navbar :is-back="true" title="科目设置" :border-bottom="false" back-icon-color="#000" :background="background"
		...
		<view class="mainBox">
			<view v-for="(item,index) in listData" :key="index">
				<selectItem :item="item"></selectItem>
			</view>
		</view>
