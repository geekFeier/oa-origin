<template>
	<view>
		<u-navbar :is-back="true" title="利润表公式" :border-bottom="false" back-icon-color="#000" :background="background"
		...
		<view class="view-list">
			...
			<view v-for="(item,index) in goodlist" :key="index" class="view-lista">
				...
				<text>{{item.calcfieldrule == 'fse' ? '发生额':'贷方发生额'}}</text>
