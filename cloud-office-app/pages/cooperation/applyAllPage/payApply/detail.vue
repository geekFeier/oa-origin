<template>
	<view>
		...
		<view class="header-div">
			<view class="header-t">{{detailData.user.username}}提交的支付申请</view>
		...
		<view class="main-box">
			<view class="mainBox">
				...
				<view class="form-item">
					...
					<view class="form-item-value">{{detailData.title}}</view>
				</view>
				...
				<view class="form-item">
					...
					<view class="form-item-img-list">
						<image v-for="(item,index) in imgData" :src="item" @click="previewBtn"
...
<script>
	...
	export default {
		...
		onLoad(e) {
			...
			console.log(this.imgData, "Aaaaaaaaaaaaaaaaaaaaaaaaaaaa");
