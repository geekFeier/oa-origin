<template>
	<view>
		...
		<view class="header-div">
			<view class="header-t">{{detailData.user.username}}提交的领用申请</view>
		...
		<view class="main-box">
			<view class="mainBox">
				...
				<view class="car-div-title">
					领用明细({{ detailData.dateils.length}})
				</view>
				<view class="form-item4">
					<view class="form-item4-div" v-for="(item,index) in detailData.dateils" :key="index">
						<view class="form-item">
							<view class="form-item-title">
								名称
							</view>
							<view class="form-item-value">{{item.name}}</view>
						</view>
						<view class="form-item">
							<view class="form-item-title">
								规格
							</view>
							<view class="form-item-value">{{item.specification}}</view>
						</view>
						<view class="form-item">
							<view class="form-item-title">
								数量
							</view>
							<view class="form-item-value">{{item.num}}</view>
						</view>
						<view class="form-item">
							<view class="form-item-title">
								单位
				...
				<view class="form-item">
					...
					<view class="form-item-img-list">
						<image v-for="(item,index) in imgData" @click="previewBtn" :src="item"
							class="form-item-img-list-i" mode=""></image>
					</view>
				</view>
			</view>
