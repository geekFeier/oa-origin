<template>
	<view>
		...
		<view class="mainBox">
			...
			<u-input v-model="value" type="textarea" :height="340" :auto-height="true" :clearable="false"
				style="margin-top: 18px;" />


			<u-form-item style="margin-top: 50rpx;" label="添加链接" label-width="150" :border-bottom="false">
				<u-input v-model="value" type="input" placeholder="请输入链接" />
			</u-form-item>



			<button type="default" class="addBtn" @click="orderPj">保存并发布</button>
		</view>
	</view>
</template>
